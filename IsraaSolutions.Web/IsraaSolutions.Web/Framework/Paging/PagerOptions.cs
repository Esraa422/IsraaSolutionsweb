...
namespace IsraaApp.WebMVC.Framework.Paging
{
    public class PagerOptions
    {
        ...
        public PagerOptions(string pageRouteValueKey)
        {
            ...
            PageRouteValueKey = string.IsNullOrEmpty(pageRouteValueKey) ? Defaults.DefaultPageRouteValueKey : pageRouteValueKey;
            PreviousPageText = DefaultDefaults.PreviousPageText;
            PreviousPageTitle = DefaultDefaults.PreviousPageTitle;
            NextPageText = DefaultDefaults.NextPageText;
            NextPageTitle = DefaultDefaults.NextPageTitle;
